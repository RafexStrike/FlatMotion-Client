...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="flex-shrink-0 border-b border-white/5 dark:border-white/5 bg-white/50 dark:bg-black/40 backdrop-blur-xl h-16 sm:h-20 flex items-center w-full transition-colors duration-300">
              ...
              <>
                ...
                {user ? (
                  <>
                    ...
                    <button
                      onClick={logout}
                      className="px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-white text-xs sm:text-sm font-semibold bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 hover:border-red-500/50 transition-all"
                    >
                      Logout
                    </button>
                    <ProfileDropdown />
                  ...
                  <>
                    ...
                    <Link
                      href="/register"
                      className="flex items-center justify-center px-5 sm:px-6 py-2 sm:py-2.5 rounded-full bg-gray-900 dark:bg-white text-white dark:text-black text-xs sm:text-sm font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition-all hover:scale-105 active:scale-95"
                    >
                      Get Started
                    </Link>
                  </>
