...
export default function VideoPreview({ url, className = '', onRegenerate }: Props) {
  ...
  return (
    <div className={`flex flex-col ${className}`}>
      <div className="relative group rounded-xl overflow-hidden bg-black border border-white/10">
        <video
          ref={videoRef}
          src={url}
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-4">
          ...
          <div className="w-full flex items-center gap-2 relative z-10 justify-end">
            ...
            <a
              ...
              className="flex items-center justify-center w-8 h-8 rounded bg-black/50 border border-white/10 text-white hover:bg-white/10 backdrop-blur-md transition-colors"
            >
            ...
            <Button
              ...
              className="bg-black/50 border-white/10 text-white hover:bg-white/10 w-8 h-8 rounded backdrop-blur-md transition-colors"
            >
